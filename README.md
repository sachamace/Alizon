...
- **Historique des commandes et annonces publiées**

### 📦 Produits & Annonces
- Ajout, **modification** et **suppression** d’annonces
- Téléversement d’images produits
- Gestion des catégories et sous-catégories
- Recherche et filtrage par nom, catégorie, prix, etc.

### 🛍️ Panier & Commandes
- Ajout d’un produit au panier
- Mise à jour des quantités
- Validation de commande et récapitulatif d’achat

### 🛠️ Interface d’administration
- Gestion des utilisateurs (activation, suspension, suppression)
- Gestion globale des produits et annonces
- Accès à des statistiques (ventes, utilisateurs actifs…)
